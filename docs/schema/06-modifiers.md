...
Хардкод по русскому имени `"ИНТЕНСИВНЫЕ ТРЕНИРОВКИ"` в
`PerksAndTraitsScreen.js` удалён: экран работает через стабильный `id` перка и
канонический каталог `data/perks/perks.json`.
