...
- выпущено в данные: **301** (ammo: 28, weapons: 164, explosives: 9, armor: 44, chems: 21, food: 27, drinks: 8)
- не выпущено: **263**
...
**Модификации оружия** (348): 164 рецептов из колонок каталога;
модов без колонок крафта (рецептов в книге нет): 0.
